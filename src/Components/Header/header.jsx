...
const Header = () => {
  return (
    <>
      ...
      >
        <div className="Logo">
          <a onClick={(e)=>{switcher('home', "", "", e)}}>Logo</a>
        </div>
        <div className="menu-section">
          <ul className="flex items-center gap-5">
            <li>
              <a onClick={(e)=>{switcher('home', "", "", e)}}>হোম</a>
            </li>
            <li>
              <a onClick={(e)=>{switcher('islam', "", "", e)}}>ইসলাম</a>
            </li>
            <li>
              <a onClick={(e)=>{switcher('ibadat', "", "", e)}}>ইবাদত</a>
            </li>
            <li>
              <a onClick={(e)=>{switcher('attoshuddhi', "", "", e)}}>আত্মশুদ্ধি</a>
            </li>
            <li>
              <a onClick={(e)=>{switcher('ibadat', "", "", e)}}>ইবাদত</a>
            </li>
            <li>
              <a onClick={(e)=>{switcher('others', "", "", e)}}>অন্যান্য</a>
            </li>
            <li></li>
          </ul>
        </div>
